# Ảnh chụp legacy gallery trước khi xóa (01/09/2026)

# ==== src/components/GalleryGrid.tsx (legacy, xóa khỏi build) ====
...
# ==== src/components/GalleryLightbox.tsx (legacy, xóa khỏi build) ====
